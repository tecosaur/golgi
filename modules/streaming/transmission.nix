...
in {
  services.transmission = {
    ...
    settings = {
      ...
      rpc-whitelist = "127.0.0.1,192.168.1.*,100.64.*.*"; # Self, LAN, Tailnet
      rpc-host-whitelist = "192.168.1.*,100.64.*.*,nas.lan,${config.site.server.host}.${config.site.apps.headscale.magicdns-subdomain}.${config.site.domain}";
