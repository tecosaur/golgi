# Generated by Powerlevel10k configuration wizard on 2020-05-08 at 20:23 AWST.
...
#
# NOTE: Looking for a nice color? Here's a one-liner to print colormap.
#
...
prompt_zvm_mode() {
  ...
  if (( $+_POWERLEVEL9K_VI_OVERWRITE_MODE_STRING )); then
      _p9k_prompt_segment $0_INSERT "$_p9k_color2" blue '' 0 '${${:-$_p9k__keymap.$_p9k__zle_state}:#(vicmd.*|vivis.*|vivli.*|*.*overwrite*)}' ""
  fi
  if (( $+_POWERLEVEL9K_VI_VISUAL_MODE_STRING )); then
    _p9k_prompt_segment $0_NORMAL "$_p9k_color2" green '' 0 '${(M)${:-$_p9k__keymap$_p9k__region_active}:#vicmd0}' ""
    _p9k_prompt_segment $0_VISUAL "$_p9k_color2" yellow '' 0 '${(M)${:-$_p9k__keymap$_p9k__region_active}:#(vicmd1|vivis?|vivli?)}' ""
  fi
  (( _p9k__has_upglob )) || typeset -g "_p9k__segment_val_${_p9k__prompt_side}[_p9k__segment_index]"=$_p9k__prompt[len+1,-1]
}

instant_prompt_zvm_mode() {
  p10k segment -b "$_p10k_color2" -f 'blue' -t '⬤'
}
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$(truec 242 '#6c6c6c')
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$(truec 232 '#242730')
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$(truec 76 '#5fd700')
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$(truec 196 '#ff0000')
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%D{%H:%M:%S} ❯'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$(truec 238 '#444444')
